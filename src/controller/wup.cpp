#if !defined(WIN32) && !defined(WIN64) && !defined(TARGET_WEB) && !defined(__SWITCH__)
...
const int BUTTON_OFFSET_VALUES[16] = {
    BTN_START, BTN_TR2, BTN_TR, BTN_TL, -1, -1, -1, -1, BTN_SOUTH, BTN_WEST, BTN_EAST, BTN_NORTH, BTN_DPAD_LEFT, BTN_DPAD_RIGHT, BTN_DPAD_DOWN, BTN_DPAD_UP,
};
