...
#include "rendering_graph_node.h"
#include "room.h"
#include "include/moving_texture.h"
#include "moving_texture.h"
 ...
 */
const u8* gMovtexIdToTexture[] = {texture_waterbox_water, texture_waterbox_mist, texture_waterbox_jrb_water, texture_waterbox_unknown_water, texture_waterbox_lava, ssl_quicksand, ssl_pyramid_sand, ttc_yellow_triangle};

/**
 * MovtexObjects that have no color attributes per vertex (though the mesh
 * as a whole can have a blend color).
 */
const struct MovtexObject gMovtexNonColored[] = {
    ...
    {MOVTEX_PYRAMID_SAND_PATHWAY_FRONT, TEX_PYRAMID_SAND_SSL, 8, ssl_movtex_tris_pyramid_sand_pathway_front, ssl_dl_pyramid_sand_pathway_begin, ssl_dl_pyramid_sand_pathway_end, ssl_dl_pyramid_sand_pathway_front_end, 0xff, 0xff, 0xff, 0xff,
     LAYER_TRANSPARENT_INTER},
    {MOVTEX_PYRAMID_SAND_PATHWAY_FLOOR, TEX_PYRAMID_SAND_SSL, 8, ssl_movtex_tris_pyramid_sand_pathway_floor, ssl_dl_pyramid_sand_pathway_floor_begin, ssl_dl_pyramid_sand_pathway_floor_end, ssl_dl_pyramid_sand_pathway_front_end, 0xff, 0xff, 0xff, 0xff,
     LAYER_OPAQUE_INTER},
    {MOVTEX_PYRAMID_SAND_PATHWAY_SIDE, TEX_PYRAMID_SAND_SSL, 6, ssl_movtex_tris_pyramid_sand_pathway_side, ssl_dl_pyramid_sand_pathway_begin, ssl_dl_pyramid_sand_pathway_end, ssl_dl_pyramid_sand_pathway_side_end, 0xff, 0xff, 0xff, 0xff,
     LAYER_TRANSPARENT_INTER},

    // The waterfall outside the castle
    {MOVTEX_CASTLE_WATERFALL, TEXTURE_WATER, 15, castle_grounds_movtex_tris_waterfall, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, castle_grounds_dl_waterfall, 0xff, 0xff, 0xff, 0xb4, LAYER_TRANSPARENT_INTER},

    // Bowser in the Fire Sea has lava at 3 heights, lava_floor is the lowest
    // and lava_second_section is the highest
    {MOVTEX_BITFS_LAVA_FIRST, TEXTURE_LAVA, 4, bitfs_movtex_tris_lava_first_section, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, bitfs_dl_lava_sections, 0xff, 0xff, 0xff, 0xff, LAYER_OPAQUE},
    {MOVTEX_BITFS_LAVA_SECOND, TEXTURE_LAVA, 4, bitfs_movtex_tris_lava_second_section, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, bitfs_dl_lava_sections, 0xff, 0xff, 0xff, 0xb4, LAYER_TRANSPARENT},
    {MOVTEX_BITFS_LAVA_FLOOR, TEXTURE_LAVA, 9, bitfs_movtex_tris_lava_floor, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, bitfs_dl_lava_floor, 0xff, 0xff, 0xff, 0xb4, LAYER_TRANSPARENT},
    ...
    {MOVTEX_LLL_LAVA_FLOOR, TEXTURE_LAVA, 9, lll_movtex_tris_lava_floor, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, lll_dl_lava_floor, 0xff, 0xff, 0xff, 0xc8, LAYER_TRANSPARENT},
    {MOVTEX_VOLCANO_LAVA_FALL, TEXTURE_LAVA, 16, lll_movtex_tris_lavafall_volcano, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, lll_dl_lavafall_volcano, 0xff, 0xff, 0xff, 0xb4, LAYER_TRANSPARENT_INTER},
    ...
    {MOVTEX_TTM_BEGIN_WATERFALL, TEXTURE_WATER, 6, ttm_movtex_tris_begin_waterfall, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, ttm_dl_waterfall, 0xff, 0xff, 0xff, 0xb4, LAYER_TRANSPARENT},
    {MOVTEX_TTM_END_WATERFALL, TEXTURE_WATER, 6, ttm_movtex_tris_end_waterfall, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, ttm_dl_waterfall, 0xff, 0xff, 0xff, 0xb4, LAYER_TRANSPARENT},
    {MOVTEX_TTM_BEGIN_PUDDLE_WATERFALL, TEXTURE_WATER, 4, ttm_movtex_tris_begin_puddle_waterfall, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, ttm_dl_bottom_waterfall, 0xff, 0xff, 0xff, 0xb4, LAYER_TRANSPARENT_INTER},
    {MOVTEX_TTM_END_PUDDLE_WATERFALL, TEXTURE_WATER, 4, ttm_movtex_tris_end_puddle_waterfall, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, ttm_dl_bottom_waterfall, 0xff, 0xff, 0xff, 0xb4, LAYER_TRANSPARENT_INTER},
    {MOVTEX_TTM_PUDDLE_WATERFALL, TEXTURE_WATER, 8, ttm_movtex_tris_puddle_waterfall, (Gfx*)dl_waterbox_rgba16_begin, (Gfx*)dl_waterbox_end, ttm_dl_puddle_waterfall, 0xff, 0xff, 0xff, 0xb4, LAYER_TRANSPARENT_INTER},
...
Gfx* movtex_gen_from_quad(s16 y, struct MovtexQuad* quad)
{
	...
	{
		quad->rot += rotspeed / FRAME_RATE_SCALER_INV;
	}
	rot = quad->rot;
	...
	if(textureId != gMovetexLastTextureId)
	{
		...
		{ // an ia16 texture
			...
			gDPTileSync(gfx++);
			gDPSetTile(gfx++, G_IM_FMT_IA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD);
			gDPLoadSync(gfx++);
		...
		{ // any rgba16 texture
			...
			gDPTileSync(gfx++);
			gDPSetTile(gfx++, G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD);
			gDPLoadSync(gfx++);
			gDPLoadBlock(gfx++, G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES));
			if(0)
			{
...
{
	struct MovtexQuadCollection* collection = (MovtexQuadCollection*)segmented_to_virtual(movetexQuadsSegmented);
	s32 i					= 0;
 ...
 */
const MovtexQuadCollection* get_quad_collection_from_id(u32 id)
{
	switch(id)
	{
...
Gfx* geo_movtex_draw_water_regions(s32 callContext, struct GraphNode* node, UNUSED f32 mtx[4][4])
{
	...
	if(callContext == GEO_CONTEXT_RENDER)
	{
		...
		quadCollection = (void*)get_quad_collection_from_id(asGenerated->parameter);
...
void update_moving_texture_offset(s16* movtexVerts, s32 attr)
{
	...
	if(gMovtexCounter != gMovtexCounterPrev)
	{
		*curOffset += movSpeed / FRAME_RATE_SCALER_INV;
