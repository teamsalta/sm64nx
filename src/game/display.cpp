...
void display_frame_buffer(void)
{
	...
	gDPSetColorImage(gDisplayListHead++, G_IM_FMT_RGBA, G_IM_SIZ_16b, SCREEN_WIDTH, gPhysicalFrameBuffers[frameBufferIndex]);
...
#if BORDER_HEIGHT != 0
	gDPFillRectangle(gDisplayListHead++, GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(0), 0, GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(0) - 1, BORDER_HEIGHT - 1);
	gDPFillRectangle(gDisplayListHead++, GFX_DIMENSIONS_RECT_FROM_LEFT_EDGE(0), SCREEN_HEIGHT - BORDER_HEIGHT, GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(0) - 1, SCREEN_HEIGHT - 1);
#endif
}
...
void func_80247D84(void)
{
	...
	// TODO osRecvMesg(&gGameVblankQueue, &D_80339BEC, OS_MESG_BLOCK);
	// TODO osRecvMesg(&gGameVblankQueue, &D_80339BEC, OS_MESG_BLOCK);
}
