...
/**
 * Behavior for sm64::bhv::bhvMontyMole(), sm64::bhv::bhvMontyMoleHole(), and sm64::bhv::bhvMontyMoleRock().
...
/**
 * Update function for sm64::bhv::bhvMontyMoleHole().
 */
void bhv_monty_mole_hole_update(void)
{
	...
	if(o->parentObj == o)
	{
		sMontyMoleHoleList   = link_objects_with_behavior(sm64::bhv::bhvMontyMoleHole());
...
/**
 * Init function for sm64::bhv::bhvMontyMole().
 */
...
static void monty_mole_act_hide(void)
{
	...
	{
		approach_f32_ptr(&o->oVelY, -4.0f, 0.5f * FRAME_RATE_SCALER);
	}
}
...
/**
 * Update function for sm64::bhv::bhvMontyMole().
 */
...
/**
 * Update function for sm64::bhv::bhvMontyMoleRock().
 */
