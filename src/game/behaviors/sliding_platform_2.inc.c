...
const void* D_80331A24[] = {
    bits_seg7_collision_0701A9A0, bits_seg7_collision_0701AA0C, bitfs_seg7_collision_07015714, bitfs_seg7_collision_07015768, rr_seg7_collision_070295F8, rr_seg7_collision_0702967C, NULL, bitdw_seg7_collision_0700F688,
};
...
void bhv_sliding_plat_2_loop(void)
{
	...
	{
		o->oBackAndForthPlatformUnkFC += o->oBackAndForthPlatformUnk100 / FRAME_RATE_SCALER_INV;
