...
/**
 * Behavior for sm64::bhv::bhvGoomba() and sm64::bhv::bhvGoombaTripletSpawner(),
...
static void goomba_act_walk(void)
{
	...
	obj_forward_vel_approach(o->oGoombaRelativeSpeed * o->oGoombaScale, 0.4f * FRAME_RATE_SCALER);
