...
{
	approach_f32_ptr(&o->header.gfx.scale[0], 0.2f, 0.002f * FRAME_RATE_SCALER);

	if(o->oTimer > 150 * FRAME_RATE_SCALER_INV && o->oDistanceToMario < 800.0f && !(o->oMoveFlags & 0x00000078))
	{
