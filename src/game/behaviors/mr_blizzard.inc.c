...
static void func_8030702C(void)
{
	...
	else if(s_check_animenumber(10))
	{
...
static void func_80307208(void)
{
	...
	{
		o->oPosY += (o->oMrBlizzardUnk10C - 24.0f) * FRAME_RATE_SCALER;
		o->oMrBlizzardUnk10C = 24.0f;
	...
	else if((o->oMrBlizzardUnkFC -= 10.0f * FRAME_RATE_SCALER) < 0.0f)
	{
...
static void func_80307370(void)
{
	...
	{
		s_chase_angleY(o->oAngleToMario, 0x600 / FRAME_RATE_SCALER_INV);
		...
		if(val06 != 0)
		{
			if(val06 < 0)
			{
				o->oMrBlizzardUnk108 -= 8.0f * FRAME_RATE_SCALER;
			}
			else
			{
				o->oMrBlizzardUnk108 += 8.0f * FRAME_RATE_SCALER;
			...
			o->oMrBlizzardUnk104 += o->oMrBlizzardUnk108 * FRAME_RATE_SCALER;
		}
		else if(o->oMrBlizzardUnk104 != 0.0f)
		{
			...
			{
				approach_f32_ptr(&o->oMrBlizzardUnk108, 1000.0f, 80.0f * FRAME_RATE_SCALER);
			}
			else
			{
				approach_f32_ptr(&o->oMrBlizzardUnk108, -1000.0f, 80.0f * FRAME_RATE_SCALER);
		...
		else if(o->oTimer > 60 * FRAME_RATE_SCALER_INV && s_calc_dangle(o->oAngleToMario, o->oMoveAngleYaw) < 0x800)
		{
			o->oAction = 4;
		}
	}
...
static void func_80307650(void)
{
	...
	else
	{
		...
		{
			o->oMrBlizzardUnk108 -= 40.0f * FRAME_RATE_SCALER;
		}
		else
		{
			o->oMrBlizzardUnk108 += 40.0f * FRAME_RATE_SCALER;
	...
	if(o->oTimer >= 30 * FRAME_RATE_SCALER_INV)
	{
		...
		{
			if((o->oMrBlizzardUnkF4 -= 0.03f * FRAME_RATE_SCALER) <= 0.0f)
			{
...
static void func_80307A0C(void)
{
	...
	if(o->oMrBlizzardUnk104 < 0.0f)
	{
		o->oMrBlizzardUnk108 += 150.0f * FRAME_RATE_SCALER;
	}
	else
	{
		o->oMrBlizzardUnk108 -= 150.0f * FRAME_RATE_SCALER;
	...
	if(approach_f32_ptr(&o->oMrBlizzardUnk10C, -200.0f, 4.0f * FRAME_RATE_SCALER))
	{
		o->oAction = 0;
		s_set_skelanimeNo(1);
	}
...
static void func_80307AD4(void)
{
	if(o->oMrBlizzardUnk100 != 0)
	{
		s_chase_angleY(o->oMrBlizzardUnk1AC, 3400 / FRAME_RATE_SCALER_INV);
	...
	else if(o->oMoveFlags & 0x00000003)
	{
		...
		{
			o->oMrBlizzardUnkTimer = 700 * FRAME_RATE_SCALER_INV;
		}
