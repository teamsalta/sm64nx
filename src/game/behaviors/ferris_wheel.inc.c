...
/**
 * Behaviors for sm64::bhv::bhvFerrisWheelAxle() and sm64::bhv::bhvFerrisWheelPlatform().
...
{
	const Collision* axleCollision;
	const Collision* platformCollision;
	s16 platformModel;
};
...
/**
 * Init function for sm64::bhv::bhvFerrisWheelAxle().
...
/**
 * Update function for sm64::bhv::bhvFerrisWheelPlatform().
