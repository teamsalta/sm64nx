...
{
	o->oTTC2DRotatorMinTimeUntilNextTurn = sTTC2DRotatorTimeBetweenTurns[o->oBehParams2ndByte][gTTCSpeedSetting] * FRAME_RATE_SCALER_INV;
...
void bhv_ttc_2d_rotator_update(void)
{
	...
	if(o->oTTC2DRotatorMinTimeUntilNextTurn != 0 && obj_face_yaw_approach(o->oTTC2DRotatorTargetYaw, 0xC8 / FRAME_RATE_SCALER_INV))
	{
		// and until MinTimeUntilNextTurn has passed.
		if(o->oTimer > o->oTTC2DRotatorMinTimeUntilNextTurn * FRAME_RATE_SCALER_INV)
		{
			...
			if(gTTCSpeedSetting == TTC_SPEED_RANDOM)
			{
				...
				if(o->oTTC2DRotatorRandomDirTimer == 0)
				{
					if(RandomU16() & 0x3)
					{
						...
						o->oTTC2DRotatorRandomDirTimer = random_mod_offset(90, 60, 4) * FRAME_RATE_SCALER_INV;
					}
					else
					{
						o->oTTC2DRotatorIncrement      = -o->oTTC2DRotatorSpeed;
						o->oTTC2DRotatorRandomDirTimer = random_mod_offset(30, 30, 3) * FRAME_RATE_SCALER_INV;
					}
				}
	...
	o->oAngleVelYaw = (o->oFaceAngleYaw - startYaw) * FRAME_RATE_SCALER_INV;
