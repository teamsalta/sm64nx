 ...
 */
static const void* sActivatedBackAndForthPlatformCollisionModels[] = {
...
void bhv_activated_back_and_forth_platform_update(void)
{
	...
	if(o->oActivatedBackAndForthPlatformVel != 0.0f)
	{
		...
		else
		{
			...
			o->oActivatedBackAndForthPlatformOffset += o->oActivatedBackAndForthPlatformVel * FRAME_RATE_SCALER;
