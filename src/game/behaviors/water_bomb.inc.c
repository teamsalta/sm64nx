...
/**
 * Behaviors for sm64::bhv::bhvWaterBombSpawner(), sm64::bhv::bhvWaterBomb(), and sm64::bhv::bhvWaterBombShadow().
...
/**
 * Update function for sm64::bhv::bhvWaterBombSpawner().
...
static void water_bomb_act_drop(void)
{
	...
	{
		approach_f32_ptr(&o->oWaterBombVerticalStretch, 0.0f, 0.008f * FRAME_RATE_SCALER);
...
/**
 * Update function for sm64::bhv::bhvWaterBomb().
 */
...
/**
 * Update function for sm64::bhv::bhvWaterBombShadow().
