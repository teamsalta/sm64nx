 ...
 */
s8 sObjectListUpdateOrder[] = {OBJ_LIST_SPAWNER, OBJ_LIST_SURFACE, OBJ_LIST_POLELIKE, OBJ_LIST_PLAYER, OBJ_LIST_PUSHABLE, OBJ_LIST_GENACTOR, OBJ_LIST_DESTRUCTIVE, OBJ_LIST_LEVEL, OBJ_LIST_DEFAULT, OBJ_LIST_UNIMPORTANT, -1};
...
struct ParticleProperties sParticleTypes[] = {
    {PARTICLE_DUST, ACTIVE_PARTICLE_0, MODEL_MIST, sm64::bhv::bhvMarioDustGenerator()},
    {PARTICLE_WALL_TINY_STAR, ACTIVE_PARTICLE_18, MODEL_NONE, sm64::bhv::bhvWallTinyStarParticleSpawn()},
    {PARTICLE_POUND_TINY_STAR, ACTIVE_PARTICLE_4, MODEL_NONE, sm64::bhv::bhvPoundTinyStarParticleSpawn()},
    {PARTICLE_SPARKLES, ACTIVE_PARTICLE_3, MODEL_SPARKLES, sm64::bhv::bhvSpecialTripleJumpSparkles()},
    {PARTICLE_WATER_BUBBLES, ACTIVE_PARTICLE_5, MODEL_BUBBLE, sm64::bhv::bhvBubbleMario()},
    {PARTICLE_WATER_SPLASH, ACTIVE_PARTICLE_6, MODEL_WATER_SPLASH, sm64::bhv::bhvWaterSplash()},
    {PARTICLE_SURFACE_WAVES, ACTIVE_PARTICLE_7, MODEL_WATER_WAVES_SURF, sm64::bhv::bhvSurfaceWaves()},
    {PARTICLE_WATER_WAVES, ACTIVE_PARTICLE_9, MODEL_WHITE_PARTICLE_SMALL, sm64::bhv::bhvWaterWaves()},
    {PARTICLE_WATER_WAKE, ACTIVE_PARTICLE_10, MODEL_WATER_WAVES, sm64::bhv::bhvWaveTrailOnSurface()},
    {PARTICLE_FLAME, ACTIVE_PARTICLE_11, MODEL_RED_FLAME, sm64::bhv::bhvFlameMario()},
    {PARTICLE_WAVES_GENERATOR, ACTIVE_PARTICLE_8, MODEL_NONE, sm64::bhv::bhvWavesGenerator()},
    {PARTICLE_WATER_WAVE_SHRINKING, ACTIVE_PARTICLE_12, MODEL_NONE, sm64::bhv::bhvSurfaceWaveShrinking()},
    {PARTICLE_LEAVES, ACTIVE_PARTICLE_13, MODEL_NONE, sm64::bhv::bhvSnowLeafParticleSpawn()},
    {PARTICLE_GROUND_SNOW, ACTIVE_PARTICLE_16, MODEL_NONE, sm64::bhv::bhvGroundSnow()},
    {PARTICLE_WATER_MIST, ACTIVE_PARTICLE_17, MODEL_NONE, sm64::bhv::bhvWaterMistSpawn()},
    {PARTICLE_GROUND_SAND, ACTIVE_PARTICLE_14, MODEL_NONE, sm64::bhv::bhvGroundSand()},
    {PARTICLE_POUND_WHITE_PUFF, ACTIVE_PARTICLE_15, MODEL_NONE, sm64::bhv::bhvPoundWhitePuffs()},
    {PARTICLE_PUNCH_TINY_TRIANGLES, ACTIVE_PARTICLE_19, MODEL_NONE, sm64::bhv::bhvPunchTinyTriangleSpawn()},
    {0, 0, MODEL_NONE, NULL},
};
...
s32 update_objects_during_time_stop(struct ObjectNode* objList, struct ObjectNode* firstObj)
{
	...
	while(objList != firstObj)
	{
		...
		if(!(gTimeStopState & TIME_STOP_ALL_OBJECTS))
		{
			...
			if((gCurrentObject->oInteractType & (INTERACT_DOOR | INTERACT_WARP_DOOR)) && !(gTimeStopState & TIME_STOP_MARIO_AND_DOORS))
			{
				unfrozen = TRUE;
			}
...
void SetStrategy(UNUSED s32 unused, struct SpawnInfo* spawnInfo)
{
	...
	while(spawnInfo != NULL)
	{
		...
		script = (BehaviorScript*)segmented_to_virtual(spawnInfo->behaviorScript);
