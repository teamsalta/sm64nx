...
extern void s_boxeffect(s16, s16, f32, s16);
extern void func_802ADA94(void);
extern void func_802ADBBC(u32);
extern void s_make_effectwind(s16, s16);
...
void bhv_bouncing_fireball_flame_init();
...
void s_1up_kinoko_init(void);
void s_1up_kinoko_main(void);
void s_1up_kinoko_escape_main(void);
void s_1up_kinoko_slider_main(void);
void s_1up_kuppa_init(void);
void s_1up_kinoko_stop_main(void);
void s_set_1up_kinoko_main(void);
void s_1up_kinoko_secret_main(void);
void s_dummy_kinoko(void);
void s_1up_secret_chase_main(void);
void s_dummy_kinoko_chase(void);
void s_1up_secret_tate_main(void);
...
void s_tbox_quize_init(void);
void s_tbox_quize_main(void);
void s_tbox_quize_ground_init(void);
void s_tbox_quize_ground_main(void);
void s_tbox_quize23_init(void);
void s_tbox_quize23_main(void);
void s_trebox_init(void);
void s_trebox_main(void);
void s_trebox_futa_main(void);
