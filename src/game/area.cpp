...
u8 D_8032CEEC[] = {
    MARIO_SPAWN_UNKNOWN_01, MARIO_SPAWN_UNKNOWN_02, MARIO_SPAWN_UNKNOWN_03, MARIO_SPAWN_UNKNOWN_03, MARIO_SPAWN_UNKNOWN_03, MARIO_SPAWN_UNKNOWN_04, MARIO_SPAWN_UNKNOWN_10, MARIO_SPAWN_UNKNOWN_12, MARIO_SPAWN_UNKNOWN_13, MARIO_SPAWN_UNKNOWN_14,
    MARIO_SPAWN_UNKNOWN_15, MARIO_SPAWN_UNKNOWN_16, MARIO_SPAWN_UNKNOWN_17, MARIO_SPAWN_UNKNOWN_11, MARIO_SPAWN_UNKNOWN_20, MARIO_SPAWN_UNKNOWN_21, MARIO_SPAWN_UNKNOWN_22, MARIO_SPAWN_UNKNOWN_23, MARIO_SPAWN_UNKNOWN_24, MARIO_SPAWN_UNKNOWN_25,
};
...
#endif
	if(((gGlobalTimer / FRAME_RATE_SCALER_INV) & 0x1F) < 20)
	{
...
void print_intro_text2(void)
{
	...
	{
		print_text_centered(160, 164, "SUPER MARIO 64 NX");
		print_text_centered(160, 58, "PRESS START");
		print_text(0, 30, "V8");
	}
}
...
void play_transition(s16 transType, s16 time, u8 red, u8 green, u8 blue)
{
	...
	gWarpTransition.time	       = time * FRAME_RATE_SCALER_INV;
	gWarpTransition.pauseRendering = FALSE;
...
{
	gWarpTransDelay = delay * FRAME_RATE_SCALER_INV; // Number of frames to delay playing the transition.
...
void render_game(void)
{
	...
	{
		geo_process_root((GraphNodeRoot*)gCurrentArea->unk04, D_8032CE74, D_8032CE78, gFBSetColor);
