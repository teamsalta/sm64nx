...
void spawn_macro_objects(s16 areaIndex, s16* macroObjList)
{
	...
	{
		if(*macroObjList == -1)
		{ // An encountered value of -1 means the list has ended.
			break;
		}
...
void spawn_macro_objects_hardcoded(s16 areaIndex, s16* macroObjList)
{
	...
	while(TRUE)
	{
		...
		{
			case 0:
				spawn_macro_abs_yrot_2params(MODEL_NONE, sm64::bhv::bhvBooBossSpawnedBridge(), macroObjX, macroObjY, macroObjZ, macroObjRY, 0);
				break;
			case 1:
				spawn_macro_abs_yrot_2params(MODEL_BBH_TILTING_FLOOR_PLATFORM, sm64::bhv::bhvBbhTiltingTrapPlatform(), macroObjX, macroObjY, macroObjZ, macroObjRY, 0);
				break;
			case 2:
				spawn_macro_abs_yrot_2params(MODEL_BBH_TUMBLING_PLATFORM, sm64::bhv::bhvBbhTumblingBridge(), macroObjX, macroObjY, macroObjZ, macroObjRY, 0);
				break;
			case 3:
				spawn_macro_abs_yrot_2params(MODEL_BBH_MOVING_BOOKSHELF, sm64::bhv::bhvHauntedBookshelf(), macroObjX, macroObjY, macroObjZ, macroObjRY, 0);
				break;
			case 4:
				spawn_macro_abs_yrot_2params(MODEL_BBH_MESH_ELEVATOR, sm64::bhv::bhvMeshElevator(), macroObjX, macroObjY, macroObjZ, macroObjRY, 0);
				break;
			case 20:
				spawn_macro_abs_yrot_2params(MODEL_YELLOW_COIN, sm64::bhv::bhvYellowCoin(), macroObjX, macroObjY, macroObjZ, macroObjRY, 0);
				break;
			case 21:
				spawn_macro_abs_yrot_2params(MODEL_YELLOW_COIN, sm64::bhv::bhvYellowCoin(), macroObjX, macroObjY, macroObjZ, macroObjRY, 0);
				break;
