...
extern Gfx* geo_movtex_draw_colored_no_update(s32 callContext, struct GraphNode* node, f32 mtx[4][4]);
extern Gfx* geo_movtex_draw_colored_2_no_update(s32 callContext, struct GraphNode* node, f32 mtx[4][4]);
