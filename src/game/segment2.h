...
extern const u8 _segment2_mio0SegmentRomStart[];
extern const u8 _segment2_mio0SegmentRomEnd[];
...
extern const u8 texture_transition_star_half[];
extern const u8 texture_transition_circle_half[];
extern const u8 texture_transition_mario[];
extern const u8 texture_transition_bowser_half[];
extern const u8 texture_waterbox_water[];
extern const u8 texture_waterbox_mist[];
...
extern const s16 seg2_triangle_mesh[];
extern const s16 seg2_mesh_order[];
extern const u8* const main_hud_lut[];
extern const Gfx RCP_tfont_main[];
extern const Gfx RCP_tfont_on[];
extern const Gfx RCP_tfont_off[];
