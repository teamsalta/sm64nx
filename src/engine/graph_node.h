...
extern struct GraphNode strategyGroup;
...
// Type used for Bowser and an size geo function in obj_behaviors.c
...
struct GraphNodeHeldObject* init_graph_node_held_object(struct AllocOnlyPool* pool, struct GraphNodeHeldObject* sp1c, struct Object* objNode, Vec3s translation, GraphNodeFunc nodeFunc, s32 playerIndex);
...
void MapSendMessage(struct GraphNode* graphNode, s32 sp1c);
