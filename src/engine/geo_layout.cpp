...
GeoLayoutCommandProc GeoLayoutJumpTable[] = {
    ...
    geo_layout_cmd_node_translation_rotation, // variable
    geo_layout_cmd_node_translation,	      // variable
    geo_layout_cmd_node_rotation,	      // variable
    geo_layout_cmd_node_animated_part,
    geo_layout_cmd_node_billboard, // variable
...
u64 GeoLayoutSizeTable[] = {
    0x02, 0x02, 0x02, 0x02, 0x04, 0x04, 0x04, 0x04, 0x0C, 0x04, 0x08, 0x04, 0x04, 0x08, 0x08, 0x14,
    0x00, // variable width
    0x00, // variable
    0x00, // variable
    0x0C,
    0x00, // variable
    0x08, 0x08, 0x04, 0x08, 0x08, 0x08, 0x04, 0x0C, 0x08, 0x08, 0x10, 0x04,
};
...
void geo_layout_cmd_node_root(void)
{
	...
	// TODO: check type
	gGeoViews = (GraphNode**)alloc_only_pool_alloc(gGraphNodePool, gGeoNumViews * sizeof(struct GraphNode*));
...
void geo_layout_cmd_node_translation_rotation(void)
{
	...
	switch((params & 0x70) >> 4)
	{
		...
		case 3:
			vec3s_copy(translation, gVec3sZero);
			SetSVector(rotation, 0, (cmdPos[1] << 15) / 180, 0);
...
void geo_layout_cmd_node_display_list(void)
{
	...
	s32 drawingLayer = cur_geo_cmd_u8(0x01);
	auto displayList = cur_geo_cmd_ptr(0x04);
...
void geo_layout_cmd_node_generated(void)
{
	...
	graphNode = init_graph_node_generated(gGraphNodePool, NULL, (GraphNodeFunc)cur_geo_cmd_ptr(0x04), /* asm function */ cur_geo_cmd_s16(0x02));
...
void geo_layout_cmd_node_held_obj(void)
{
	...
	graphNode = init_graph_node_held_object(gGraphNodePool, NULL, NULL, offset, (GraphNodeFunc)cur_geo_cmd_ptr(0x08), cur_geo_cmd_u8(0x01));
...
GraphNode* process_geo_layout(struct AllocOnlyPool* pool, GeoLayout* geo)
{
	// geo = sm64::hook::geo::apply(geo);
	...
	gGeoLayoutCommand = (u8*)geo; // (u8*)sm64::hook::geo::apply(geo);
