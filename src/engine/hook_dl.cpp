...
static GraphNodeFunc g_graphCallbacks[] = {
    ...
    (GraphNodeFunc)geo_exec_cake_end_screen,
    (GraphNodeFunc)geo_exec_flying_carpet_create,
    (GraphNodeFunc)geo_exec_flying_carpet_timer_update,
    (GraphNodeFunc)geo_exec_inside_castle_light,
    ...
    (GraphNodeFunc)geo_switch_anim_state,
    (GraphNodeFunc)geo_switch_area,
    ...
    (GraphNodeFunc)geo_update_layer_transparency,
    (GraphNodeFunc)geo_update_projectile_pos_from_parent,
