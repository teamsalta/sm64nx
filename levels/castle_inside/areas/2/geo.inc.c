...
const GeoLayout castle_geo_001578[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(  0, WaveInit),
      GEO_ASM(264, WaveMove),
      GEO_ASM(266, WaveMove),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
...
const GeoLayout castle_geo_0015F8[] = {
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_ASM(  0, WaveInit),
      GEO_ASM(265, WaveMove),
      GEO_ASM(269, WaveMove),
   GEO_CLOSE_NODE(),
   GEO_RETURN(),
};
   ...
   GEO_OPEN_NODE(),
      ...
      GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               GEO_SWITCH_CASE(11, ControlSwitchMap),
               GEO_OPEN_NODE(),
