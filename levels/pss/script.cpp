...
const LevelScript level_pss_entry[] = {
    ...
    AREA(/*index*/ 1, pss_level_geo),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 5632, 6751, -5631, /*angle*/ 0, 270, 0, /*behParam*/ 0x000A0000, /*beh*/ sm64::bhv::bhvWarps64()),
