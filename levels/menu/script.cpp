...
const LevelScript level_main_menu_entry_1[] = {
    ...
    AREA(/*index*/ 1, menu_file_select_strings_and_menu_cursor_level_geo),
        OBJECT(/*model*/ MODEL_NONE,         /*pos*/ 0, 0, -19000, /*angle*/ 0, 0, 0, /*behParam*/ 0x04000000, /*beh*/ sm64::bhv::bhvMenuButtonManager()),
        OBJECT(/*model*/ MODEL_MAIN_MENU_YELLOW_FILE_BUTTON, /*pos*/ 0, 0, -19000, /*angle*/ 0, 0, 0, /*behParam*/ 0x04000000, /*beh*/ sm64::bhv::bhvYellowBackgroundInMenu()),
...
const LevelScript level_main_menu_entry_2[] = {
    ...
    /*14*/ AREA(/*index*/ 2, geo_menu_act_selector_strings),
        /*16*/ OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0, -100, 0, /*angle*/ 0, 0, 0, /*behParam*/ 0x04000000, /*beh*/ sm64::bhv::bhvActSelector()),
...
namespace sm64
{
	EXPORT_LEVEL(level_main_menu_entry_1);
	EXPORT_LEVEL(level_main_menu_entry_2);
}
