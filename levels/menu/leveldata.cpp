...
namespace sm64
{
	EXPORT_DL(dl_tex_block_menu_save_button_base);
	EXPORT_DL(dl_vertex_menu_save_button_borders);
	EXPORT_DL(dl_vertex_menu_save_button_front);
	EXPORT_DL(dl_tex_block_menu_save_button_back);
	EXPORT_DL(dl_vertex_menu_save_button_back);
	EXPORT_DL(dl_menu_mario_save_button_base);
	EXPORT_DL(dl_menu_mario_new_button_base);
	EXPORT_DL(dl_menu_save_button_back);
	EXPORT_DL(dl_menu_save_button_fade_back);
	EXPORT_DL(dl_vertex_menu_main_button);
	EXPORT_DL(dl_tex_block_menu_main_button);
	EXPORT_DL(dl_menu_main_button);
	EXPORT_DL(dl_menu_erase_button);
	EXPORT_DL(dl_menu_copy_button);
	EXPORT_DL(dl_menu_file_button);
	EXPORT_DL(dl_menu_score_button);
	EXPORT_DL(dl_menu_sound_button);
	EXPORT_DL(dl_menu_generic_button);
	EXPORT_DL(dl_menu_hand);
	EXPORT_DL(dl_menu_idle_hand);
	EXPORT_DL(dl_menu_grabbing_hand);
	EXPORT_DL(dl_menu_ia8_text_begin);
	EXPORT_DL(dl_menu_ia8_text_end);
	EXPORT_DL(dl_menu_rgba16_wood_course);
}
