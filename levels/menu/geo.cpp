...
// 0x0E000380
const GeoLayout menu_file_select_strings_and_menu_cursor_level_geo[] = {
...
namespace sm64::geo
{
	EXPORT_GEO(geo_menu_mario_save_button);
	EXPORT_GEO(geo_menu_mario_save_button_fade);
	EXPORT_GEO(geo_menu_mario_new_button);
	EXPORT_GEO(geo_menu_mario_new_button_fade);
	EXPORT_GEO(geo_menu_erase_button);
	EXPORT_GEO(geo_menu_copy_button);
	EXPORT_GEO(geo_menu_file_button);
	EXPORT_GEO(geo_menu_score_button);
	EXPORT_GEO(geo_menu_sound_button);
	EXPORT_GEO(geo_menu_generic_button);
	EXPORT_GEO(menu_file_select_strings_and_menu_cursor_level_geo);
	EXPORT_GEO(geo_menu_act_selector_strings);
}
