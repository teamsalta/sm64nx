...
static const LevelScript script_func_local_1[] = {
    OBJECT(/*model*/ MODEL_CAP_SWITCH, /*pos*/ 0,  363, -6144, /*angle*/ 0, 0, 0, /*behParam*/ 0x00010000, /*beh*/ sm64::bhv::bhvCapSwitch()),
    OBJECT(/*model*/ MODEL_NONE,       /*pos*/ 0,  500, -7373, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ sm64::bhv::bhvWaterfallSoundLoop()),
    OBJECT(/*model*/ MODEL_NONE,       /*pos*/ 0,  500,  3584, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ sm64::bhv::bhvWaterfallSoundLoop()),
    RETURN(),
};

static const LevelScript script_func_local_2[] = {
    OBJECT(/*model*/ MODEL_NONE,       /*pos*/ 0, -200, -7000, /*angle*/ 0, 0, 0, /*behParam*/ 0x00000000, /*beh*/ sm64::bhv::bhvHiddenRedCoinStar()),
    RETURN(),
};
...
const LevelScript level_cotmc_entry[] = {
    ...
    AREA(/*index*/ 1, cotmc_level_geo),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ -4185, 1020, -47, /*angle*/ 0, 90, 0, /*behParam*/ 0x000A0000, /*beh*/ sm64::bhv::bhvWarps64()),
...
namespace sm64
{
	...
	EXPORT_LEVEL(level_cotmc_entry);
}
