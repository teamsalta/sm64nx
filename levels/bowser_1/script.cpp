...
const LevelScript level_bowser_1_entry[] = {
    ...
    AREA(/*index*/ 1, bowser_1_level_geo),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/ 0, 1307, 0, /*angle*/ 0, 180, 0, /*behParam*/ 0x000A0000, /*beh*/ sm64::bhv::bhvWarps6C()),
...
namespace sm64
{
	EXPORT_LEVEL(level_bowser_1_entry);
}
