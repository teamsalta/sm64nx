...
const BehaviorScript bhvBobombFuseSmoke[] = {
    ...
    DELAY(1),
    BEGIN_LOOP(),
        CALL_NATIVE(s_samplesmoke_main),
        ADD_INT(oAnimState, 1),
    END_LOOP(),
};
...
const BehaviorScript bhvButterfly[] = {
    ...
    CALL_NATIVE(s_butterflyInit),
    BEGIN_LOOP(),
        CALL_NATIVE(s_butterflyfunc),
    END_LOOP(),
};
...
const BehaviorScript bhvPitBowlingBall[] = {
    ...
    CALL_NATIVE(s_ironball_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_ironball),
    END_LOOP(),
};
...
const BehaviorScript bhvFreeBowlingBall[] = {
    ...
    BILLBOARD(),
    SET_FLOAT(oGraphYOffset, 130),
    CALL_NATIVE(s_ironball_normal_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_ironball_normal_main),
    END_LOOP(),
};
...
const BehaviorScript bhvBowlingBall[] = {
    ...
    BILLBOARD(),
    SET_FLOAT(oGraphYOffset, 130),
    CALL_NATIVE(s_rail_ironball_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_rail_ironball),
    END_LOOP(),
};
...
const BehaviorScript bhvTtmBowlingBallSpawner[] = {
    ...
    CALL_NATIVE(s_gush_ironball_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_gush_ironball),
    END_LOOP(),
};
...
const BehaviorScript bhvWingCap[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    CALL_NATIVE(s_itemhat_wing_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_itemhat_wing_main),
    END_LOOP(),
};
...
const BehaviorScript bhvMetalCap[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    CALL_NATIVE(s_itemhat_metal_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_itemhat_metal_main),
    END_LOOP(),
};
...
const BehaviorScript bhvNormalCap[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    CALL_NATIVE(s_itemhat_blow_init),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(s_itemhat_blow_main),
    END_LOOP(),
};
...
const BehaviorScript bhvVanishCap[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    CALL_NATIVE(s_itemhat_erase_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_itemhat_wing_main),
    END_LOOP(),
};
...
const BehaviorScript bhvStar[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    CALL_NATIVE(s_areastage_init),
    CALL_NATIVE(s_polystar_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_polystar_main),
    END_LOOP(),
};
...
const BehaviorScript bhvStarSpawnCoordinates[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    CALL_NATIVE(s_polystar_init),
    CALL_NATIVE(s_enemy_star_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_enemy_star_main),
    END_LOOP(),
};
...
const BehaviorScript bhvHiddenRedCoinStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    CALL_NATIVE(s_getcoins_star_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_getcoins_star_main),
    END_LOOP(),
};
...
const BehaviorScript bhvRedCoin[] = {
    ...
    SET_INT(oAnimState, -1),
    CALL_NATIVE(s_areastage_init),
    CALL_NATIVE(s_coin_appear_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_coin_appear_main),
        ADD_INT(oAnimState, 1),
    END_LOOP(),
};
...
const BehaviorScript bhvBowserCourseRedCoinStar[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(s_getcoins_extstar_main),
    END_LOOP(),
};
...
const BehaviorScript bhvHiddenStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    CALL_NATIVE(s_getdummy_star_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_getdummy_star_main),
    END_LOOP(),
};
...
const BehaviorScript bhvTtmRollingLog[] = {
    ...
    SET_HOME(),
    SET_FLOAT(oCollisionDistance, 2000),
    CALL_NATIVE(s_don_maruta_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_don_maruta_main),
        CALL_NATIVE(stMainMoveBG),
    END_LOOP(),
};
...
const BehaviorScript bhv1upWalking[] = {
    ...
    SET_FLOAT(oGraphYOffset, 30),
    CALL_NATIVE(s_1up_kinoko_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_1up_kinoko_main),
    END_LOOP(),
};
...
const BehaviorScript bhv1upRunningAway[] = {
    ...
    CALL_NATIVE(s_1up_kinoko_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_1up_kinoko_escape_main),
    END_LOOP(),
};
...
const BehaviorScript bhv1upSliding[] = {
    ...
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(s_1up_kinoko_slider_main),
    END_LOOP(),
};
...
const BehaviorScript bhv1Up[] = {
    ...
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 30, /*Height*/ 30, /*Downwards offset*/ 0),
    SET_FLOAT(oGraphYOffset, 30),
    CALL_NATIVE(s_1up_kuppa_init),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(s_1up_kinoko_stop_main),
    END_LOOP(),
};
...
const BehaviorScript bhv1upJumpOnApproach[] = {
    ...
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(s_set_1up_kinoko_main),
    END_LOOP(),
};
...
const BehaviorScript bhvHidden1up[] = {
    ...
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(s_1up_kinoko_secret_main),
    END_LOOP(),
};
...
const BehaviorScript bhvHidden1upInPole[] = {
    ...
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(s_1up_secret_chase_main),
    END_LOOP(),
};
...
const BehaviorScript bhvHidden1upInPoleTrigger[] = {
    ...
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(s_dummy_kinoko_chase),
    END_LOOP(),
};
...
const BehaviorScript bhvHidden1upInPoleSpawner[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(s_1up_secret_tate_main),
    END_LOOP(),
};
...
const BehaviorScript bhvControllablePlatform[] = {
    ...
    SET_HOME(),
    CALL_NATIVE(s_NEWSlift_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_NEWSlift_main),
        CALL_NATIVE(stMainMoveBG),
    END_LOOP(),
};
...
const BehaviorScript bhvBreakableBoxSmall[] = {
    ...
    DROP_TO_FLOOR(),
    SET_HOME(),
    CALL_NATIVE(s_takeblock_init),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(s_takeblock_main),
    END_LOOP(),
};
...
const BehaviorScript bhvSlidingSnowMound[] = {
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(s_iwanami_parts_main),
        CALL_NATIVE(stMainMoveBG),
    END_LOOP(),
};
...
const BehaviorScript bhvWdwSquareFloatingPlatform[] = {
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(s_floatingboard_main),
        CALL_NATIVE(stMainMoveBG),
    END_LOOP(),
};
...
const BehaviorScript bhvArrowLift[] = {
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(s_po_moveblock_main),
        CALL_NATIVE(stMainMoveBG),
    END_LOOP(),
};
...
const BehaviorScript bhvOrangeNumber[] = {
    ...
    BILLBOARD(),
    SET_HOME(),
    CALL_NATIVE(s_numbers_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_numbers_main),
    END_LOOP(),
};
...
const BehaviorScript bhvMantaRay[] = {
    ...
    ANIMATE(0),
    CALL_NATIVE(s_d_manta_init),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(s_d_manta_main),
    END_LOOP(),
};
...
const BehaviorScript bhvFallingPillar[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    CALL_NATIVE(s_wd_pillar_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_wd_pillar_main),
    END_LOOP(),
};
...
const BehaviorScript bhvDecorativePendulum[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    CALL_NATIVE(s_clock_furiko_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_clock_furiko_main),
    END_LOOP(),
};
...
const BehaviorScript bhvTreasureChestsShip[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    DROP_TO_FLOOR(),
    CALL_NATIVE(s_tbox_quize_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_tbox_quize_main),
    END_LOOP(),
};
...
const BehaviorScript bhvTreasureChestsJrb[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    DROP_TO_FLOOR(),
    CALL_NATIVE(s_tbox_quize_ground_init),
    BEGIN_LOOP(),
        CALL_NATIVE(s_tbox_quize_ground_main),
    END_LOOP(),
};
...
const BehaviorScript bhvTreasureChestBottom[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    DROP_TO_FLOOR(),
    CALL_NATIVE(s_trebox_init),
    SET_INT(oIntangibleTimer, -1),
    BEGIN_LOOP(),
        CALL_NATIVE(s_trebox_main),
    END_LOOP(),
};
...
const BehaviorScript bhvTreasureChestTop[] = {
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(s_trebox_futa_main),
    END_LOOP(),
};
...
const BehaviorScript bhvYoshi[] = {
    ...
    ANIMATE(0),
    SET_HOME(),
    CALL_NATIVE(s_yoshi_init),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(s_yoshi_main),
    END_LOOP(),
};
...
namespace sm64::hook::bhv
{
	...
	s_yoshi_main,
	s_1up_kinoko_init,
	s_1up_secret_chase_main,
	s_1up_secret_tate_main,
	s_dummy_kinoko_chase,
	s_1up_kinoko_secret_main,
	s_dummy_kinoko,
	s_1up_kuppa_init,
	s_set_1up_kinoko_main,
	s_1up_kinoko_stop_main,
	s_1up_kinoko_escape_main,
	s_1up_kinoko_slider_main,
	s_1up_kinoko_main,
	...
	s_getcoins_star_init,
	s_getcoins_star_main,
	s_getdummy_star_init,
	s_getdummy_star_main,
	s_dummy_appear,
	bhv_homing_amp_init,
	bhv_homing_amp_loop,
	bhv_hoot_init,
	...
	s_itemhat_metal_init,
	s_itemhat_metal_main,
	bhv_mips_init,
	bhv_mips_loop,
	...
	s_trebox_main,
	s_tbox_quize23_init,
	s_tbox_quize_ground_init,
	s_tbox_quize_ground_main,
	s_tbox_quize23_main,
	s_tbox_quize_init,
	s_tbox_quize_main,
	s_trebox_futa_main,
