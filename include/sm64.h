...
#define PARTICLE_WALL_TINY_STAR        /* 0x00000002 */ (1 <<  1)
#define PARTICLE_2        /* 0x00000004 */ (1 <<  2)
#define PARTICLE_SPARKLES /* 0x00000008 */ (1 <<  3)
#define PARTICLE_POUND_TINY_STAR        /* 0x00000010 */ (1 <<  4)
#define PARTICLE_WATER_BUBBLES  /* 0x00000020 */ (1 <<  5)
#define PARTICLE_WATER_SPLASH        /* 0x00000040 */ (1 <<  6)
#define PARTICLE_SURFACE_WAVES        /* 0x00000080 */ (1 <<  7)
#define PARTICLE_WAVES_GENERATOR        /* 0x00000100 */ (1 <<  8)
#define PARTICLE_WATER_WAVES        /* 0x00000200 */ (1 <<  9)
#define PARTICLE_WATER_WAKE       /* 0x00000400 */ (1 << 10)
#define PARTICLE_FLAME       /* 0x00000800 */ (1 << 11)
#define PARTICLE_WATER_WAVE_SHRINKING       /* 0x00001000 */ (1 << 12)
#define PARTICLE_LEAVES   /* 0x00002000 */ (1 << 13)
#define PARTICLE_GROUND_SNOW       /* 0x00004000 */ (1 << 14)
#define PARTICLE_GROUND_SAND       /* 0x00008000 */ (1 << 15)
#define PARTICLE_POUND_WHITE_PUFF       /* 0x00010000 */ (1 << 16)
#define PARTICLE_WATER_MIST       /* 0x00020000 */ (1 << 17)
#define PARTICLE_PUNCH_TINY_TRIANGLES       /* 0x00040000 */ (1 << 18)
...
#define VALID_BUTTONS (sm64::hid::A_BUTTON   | sm64::hid::B_BUTTON   | sm64::hid::Z_TRIG     | sm64::hid::START_BUTTON | \
                       ...
                       sm64::hid::L_TRIG     | sm64::hid::R_TRIG     |                             \
                       sm64::hid::U_CBUTTONS | sm64::hid::D_CBUTTONS | sm64::hid::L_CBUTTONS | sm64::hid::R_CBUTTONS   )

#define C_BUTTONS     (sm64::hid::U_CBUTTONS | sm64::hid::D_CBUTTONS | sm64::hid::L_CBUTTONS | sm64::hid::R_CBUTTONS   )
