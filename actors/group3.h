...
// king_bobomb
namespace sm64::geo { const GeoLayout* king_bobomb_geo(); }
...
// water_bubble
namespace sm64::geo { const GeoLayout* water_bomb_geo(); }
namespace sm64::geo { const GeoLayout* water_bomb_shadow_geo(); }
