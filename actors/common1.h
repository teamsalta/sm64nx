...
// blue_fish
namespace sm64::geo { const GeoLayout* fish_shadow_geo(); }
namespace sm64::geo { const GeoLayout* fish_geo(); }
...
// bowser_key
namespace sm64::geo { const GeoLayout* bowser_key_geo(); }
namespace sm64::geo { const GeoLayout* bowser_key_cutscene_geo(); }
extern const Gfx bowser_key_dl[];
extern const struct Animation *const bowser_key_seg3_anims_list[];

// butterfly
namespace sm64::geo { const GeoLayout* butterfly_geo(); }
...
// coin
namespace sm64::geo { const GeoLayout* yellow_coin_geo(); }
namespace sm64::geo { const GeoLayout* yellow_coin_no_shadow_geo(); }
namespace sm64::geo { const GeoLayout* blue_coin_geo(); }
namespace sm64::geo { const GeoLayout* blue_coin_no_shadow_geo(); }
namespace sm64::geo { const GeoLayout* red_coin_geo(); }
namespace sm64::geo { const GeoLayout* red_coin_no_shadow_geo(); }
...
// dirt
namespace sm64::geo { const GeoLayout* dirt_animation_geo(); }
namespace sm64::geo { const GeoLayout* cartoon_star_geo(); }
...
// door
namespace sm64::geo { const GeoLayout* castle_door_geo(); }
namespace sm64::geo { const GeoLayout* cabin_door_geo(); }
namespace sm64::geo { const GeoLayout* wooden_door_geo(); }
namespace sm64::geo { const GeoLayout* wooden_door2_geo(); }
namespace sm64::geo { const GeoLayout* metal_door_geo(); }
namespace sm64::geo { const GeoLayout* hazy_maze_door_geo(); }
namespace sm64::geo { const GeoLayout* haunted_door_geo(); }
namespace sm64::geo { const GeoLayout* castle_door_0_star_geo(); }
namespace sm64::geo { const GeoLayout* castle_door_1_star_geo(); }
namespace sm64::geo { const GeoLayout* castle_door_3_stars_geo(); }
namespace sm64::geo { const GeoLayout* key_door_geo(); }
...
// explosion
namespace sm64::geo { const GeoLayout* explosion_geo(); }
...
// flame
namespace sm64::geo { const GeoLayout* red_flame_shadow_geo(); }
namespace sm64::geo { const GeoLayout* red_flame_geo(); }
namespace sm64::geo { const GeoLayout* blue_flame_geo(); }
...
// leaves
namespace sm64::geo { const GeoLayout* leaves_geo(); }
...
// mist
namespace sm64::geo { const GeoLayout* mist_geo(); }
namespace sm64::geo { const GeoLayout* white_puff_geo(); }
extern const Gfx mist_seg3_dl_03000880[];
extern const Gfx mist_seg3_dl_03000920[];

// mushroom_1up
namespace sm64::geo { const GeoLayout* mushroom_1up_geo(); }
extern const Gfx mushroom_1up_seg3_dl_0302A628[];
extern const Gfx mushroom_1up_seg3_dl_0302A660[];

// number
namespace sm64::geo { const GeoLayout* number_geo(); }
...
// star
namespace sm64::geo { const GeoLayout* star_geo(); }
...
// transparent_star
namespace sm64::geo { const GeoLayout* transparent_star_geo(); }
extern const Gfx transparent_star_seg3_dl_0302C560[];
extern const Gfx transparent_star_seg3_dl_0302C620[];

// tree
namespace sm64::geo { const GeoLayout* bubbly_tree_geo(); }
namespace sm64::geo { const GeoLayout* spiky_tree_geo(); }
namespace sm64::geo { const GeoLayout* snow_tree_geo(); }
namespace sm64::geo { const GeoLayout* spiky_tree1_geo(); }
namespace sm64::geo { const GeoLayout* palm_tree_geo(); }
...
// warp_pipe
namespace sm64::geo { const GeoLayout* warp_pipe_geo(); }
...
// white_particle
namespace sm64::geo { const GeoLayout* white_particle_geo(); }
extern const Gfx white_particle_dl[];

// wooden_signpost
namespace sm64::geo { const GeoLayout* wooden_signpost_geo(); }
