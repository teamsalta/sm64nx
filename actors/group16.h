...
namespace sm64::geo { const GeoLayout* chilly_chief_geo(); }
namespace sm64::geo { const GeoLayout* chilly_chief_big_geo(); }
extern const struct Animation *const chilly_chief_seg6_anims_06003994[];

// moneybag
namespace sm64::geo { const GeoLayout* moneybag_geo_000000(); }
namespace sm64::geo { const GeoLayout* moneybag_geo_000078(); }
namespace sm64::geo { const GeoLayout* moneybag_geo(); }
