...
// capswitch
namespace sm64::geo { const GeoLayout* cap_switch_geo(); }
...
// springboard
namespace sm64::geo { const GeoLayout* springboard_top_geo(); }
namespace sm64::geo { const GeoLayout* springboard_spring_geo(); }
namespace sm64::geo { const GeoLayout* springboard_bottom_geo(); }
