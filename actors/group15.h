...
// boo_castle
namespace sm64::geo { const GeoLayout* boo_castle_geo(); }
...
// lakitu_cameraman
namespace sm64::geo { const GeoLayout* lakitu_geo(); }
...
// mips
namespace sm64::geo { const GeoLayout* mips_geo(); }
...
// toad
namespace sm64::geo { const GeoLayout* toad_geo_000114(); }
namespace sm64::geo { const GeoLayout* toad_geo_00027C(); }
namespace sm64::geo { const GeoLayout* toad_geo(); }
